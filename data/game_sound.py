...
class Sound(object):
    """Maneja todo el sonido para el juego"""
    ...
    def set_music_mixer(self):
        """Establece la música para el nivel"""
    ...
    def update(self, game_info, mario):
        """Actualiza el objeto de sonido con información del juego"""
        self.game_info = game_info
        self.mario = mario
        self.handle_state()

    def  handle_state(self):
        """Maneja el estado del objeto de sonido"""
