...
class Menu(tools._State):
    ...
    def startup(self, current_time, persist):
        """Se llama cada vez que el estado del juego pasa a ser éste. Inicializa
        ciertos valores"""
    ...
    def setup_cursor(self):
        """Crea el cursor de hongo para seleccionar el juego de 1 o 2 jugadores"""
    ...
    def get_image(self, x, y, width, height, dest, sprite_sheet):
        """Devuelve imágenes y rectas para blit en la pantalla"""
    ...
    def update(self, surface, keys, current_time):
        """Actualiza el estado cada actualización"""
    ...
    def reset_game_info(self):
        """Restablece la información del juego en caso de Game Over y reinicia"""
