...
class Character(pg.sprite.Sprite):
    """Clase principal para todos los caracteres utilizados para la información de nivel superior"""
...
class OverheadInfo(object):
    """Clase para información de nivel como puntaje, total de monedas,
        y tiempo restante"""
    ...
    def create_score_group(self):
        """Crea la puntuación vacía inicial (000000)"""
        self.score_images = []
    ...
    def create_label(self, label_list, string, x, y):
        """Crea una etiqueta (MUNDO, HORA, MARIO)"""
    ...
    def set_label_rects(self, label_list, x, y):
        """Establecer la ubicación de cada carácter individual"""
    ...
    def create_coin_counter(self):
        """Crea la información que rastrea la cantidad de monedas que recolecta Mario."""
        self.coin_count_images = []
        self.create_label(self.coin_count_images, '*00', 300, 55)


    def create_flashing_coin(self):
        """Crea la moneda parpadeante al lado del total de la moneda"""
    ...
    def create_time_out_label(self):
        """Crear la etiqueta para la pantalla de tiempo de espera"""
        time_out_label = []
    ...
    def update(self, level_info, mario=None):
        """Actualiza toda la información de gastos generales"""
        self.mario = mario
    ...
    def update_score_images(self, images, score):
        """Actualiza qué números se borrarán para el puntaje"""
        index = len(images) - 1
